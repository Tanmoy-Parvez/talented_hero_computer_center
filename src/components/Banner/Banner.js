        ...
        <div>
            <div className="row px-5">
                <div className="col-md-6 p-5">
                    ...
                    <h1 className="title text-warning fw-bold">IT solutions</h1>
                    ...
                    <div className="info">
                        <button className="btn btn-warning px-5 py-2 fs-5 my-4 text-light fw-bold">About Us</button>
                        <div className="ms-5 d-flex align-items-center text-warning">
